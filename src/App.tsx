...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="fixed top-0 w-full shadow-md z-50 transition-all duration-300 border-b-2" style={{ backgroundColor: '#04804A', borderColor: '#04804A' }}>
        <nav className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="#home" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>Home</a>
              <a href="#about" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>About</a>
              <a href="#services" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>Services</a>
              <a href="#what-we-offer" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>What We Offer</a>
              <a href="#gallery" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>Gallery</a>
              <a href="#testimonials" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>Testimonials</a>
              <a href="#contact" className="text-white transition-colors font-medium" style={{ opacity: 0.95 }} onMouseEnter={(e) => e.currentTarget.style.color = '#AD9044'} onMouseLeave={(e) => e.currentTarget.style.color = 'white'}>Contact</a>
              <a
                href="tel:+15162340786"
                className="text-white px-6 py-2.5 rounded-full hover:shadow-lg transition-all duration-300 font-semibold border-2"
                style={{ backgroundColor: '#AD9044', borderColor: '#AD9044' }}
              >
                Call Now
              </a>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-4 animate-fadeIn">
              <a href="#home" className="block text-white hover-gold transition-colors font-medium">Home</a>
              <a href="#about" className="block text-white hover-gold transition-colors font-medium">About</a>
              <a href="#services" className="block text-white hover-gold transition-colors font-medium">Services</a>
              <a href="#what-we-offer" className="block text-white hover-gold transition-colors font-medium">What We Offer</a>
              <a href="#gallery" className="block text-white hover-gold transition-colors font-medium">Gallery</a>
              <a href="#testimonials" className="block text-white hover-gold transition-colors font-medium">Testimonials</a>
              <a href="#contact" className="block text-white hover-gold transition-colors font-medium">Contact</a>
            </div>
          )}
        </nav>
      </header>

      <section id="home" className="pt-32 pb-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fadeIn leading-tight font-hero" style={{ color: '#04804A' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fadeIn" style={{ animationDelay: '0.4s' }}>
              <a
                ...
                style={{ backgroundColor: '#04804A', borderColor: '#04804A' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = '#AD9044';
                  e.currentTarget.style.borderColor = '#AD9044';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = '#04804A';
                  e.currentTarget.style.borderColor = '#04804A';
                }}
              >
                Get a Free Quote
              </a>
              <a
                href="tel:+15162340786"
                className="text-white px-10 py-4 rounded-full text-lg font-bold hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center gap-2 border-2"
                style={{ backgroundColor: '#AD9044', borderColor: '#AD9044' }}
              >
      ...
      <section id="services" className="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#04804A' }}>Our Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {services.map((service, index) => (
              <div
                ...
                style={{ borderTopColor: '#AD9044' }}
              >
                <div className="w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: 'rgba(4, 128, 74, 0.1)' }}>
                  <service.icon className="h-8 w-8" style={{ color: '#04804A' }} />
                </div>
      ...
      <section id="gallery" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#04804A' }}>Travel Highlights</h2>
      ...
      <section className="py-24 text-white relative overflow-hidden" style={{ background: 'linear-gradient(to bottom right, #04804A, #036339)' }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>Your satisfaction is our priority</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              ...
              >
                <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-all duration-300 border-2" style={{ backgroundColor: 'rgba(173, 144, 68, 0.2)', borderColor: '#AD9044' }}>
                  <feature.icon className="h-10 w-10" style={{ color: '#AD9044' }} />
                </div>
      ...
      <section id="what-we-offer" className="py-20 md:py-24" style={{ backgroundColor: '#F6F3EE' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-[680px] mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center font-playfair" style={{ color: '#04804A' }}>
              What We Offer
            </h2>
      ...
      <section id="testimonials" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#04804A' }}>What Our Clients Say</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-50 via-white to-gray-50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-t-4"
                style={{ borderTopColor: '#AD9044' }}
              >
                <div className="flex mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="h-5 w-5" style={{ fill: '#AD9044', color: '#AD9044' }} />
                  ))}
                </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#04804A' }}>Follow Us on Social Media</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#04804A' }}>Get In Touch</h2>
              <p className="text-xl text-gray-600">Ready to plan your next adventure? Contact us today!</p>
            </div>

            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="flex items-start space-x-4 bg-white p-6 rounded-2xl shadow-md border-l-4" style={{ borderLeftColor: '#AD9044' }}>
                  <div className="p-4 rounded-full" style={{ backgroundColor: '#AD9044' }}>
                    <Phone className="h-7 w-7 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2 text-lg">Phone</h3>
                    <a href="tel:+15162340786" className="text-xl font-semibold hover-gold transition-colors" style={{ color: '#04804A' }}>
                      (516) 234-0786
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 bg-white p-6 rounded-2xl shadow-md border-l-4" style={{ borderLeftColor: '#AD9044' }}>
                  <div className="p-4 rounded-full" style={{ backgroundColor: '#04804A' }}>
                    <MapPin className="h-7 w-7 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2 text-lg">Website</h3>
                    <a href="https://www.zemkaytravels.com" className="text-lg hover-gold transition-colors" style={{ color: '#04804A' }}>
                      www.zemkaytravels.com
                    </a>
                  </div>
                </div>

                <div className="text-white p-8 rounded-2xl shadow-lg" style={{ background: 'linear-gradient(to bottom right, #04804A, #036339)' }}>
              ...
              <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-xl border-t-4" style={{ borderTopColor: '#AD9044' }}>
                <div className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full text-white py-4 rounded-lg font-bold text-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    style={{ backgroundColor: '#04804A', borderColor: '#04804A' }}
                    onMouseEnter={(e) => {
                      if (!isSubmitting) {
                        e.currentTarget.style.backgroundColor = '#AD9044';
      ...
      <footer className="bg-gray-900 text-white py-12 border-t-4" style={{ borderTopColor: '#AD9044' }}>
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h3 className="text-xl font-bold mb-4" style={{ color: '#AD9044' }}>Quick Links</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-4" style={{ color: '#AD9044' }}>Contact Us</h3>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center space-x-2">
                  <Phone className="h-5 w-5" style={{ color: '#AD9044' }} />
                  <a href="tel:+15162340786" className="text-gray-400 transition-colors font-semibold hover-gold">
                    (516) 234-0786
                  </a>
                </li>
                <li className="flex items-center space-x-2">
                  <MapPin className="h-5 w-5" style={{ color: '#AD9044' }} />
              ...
              <div>
                <h4 className="text-lg font-bold mb-3" style={{ color: '#AD9044' }}>Follow Us</h4>
      ...
      <a
        href="tel:+15162340786"
        className="fixed bottom-6 right-6 text-white p-5 rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 z-50 animate-bounce border-2"
        style={{ backgroundColor: '#04804A', borderColor: '#04804A', animationDuration: '3s' }}
